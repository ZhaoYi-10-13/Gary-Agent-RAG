...
This repository presents an Agent system, designed for users in China who cannot open overseas services due to the lack of a Visa and Mastercard by integrating Chinese service providers for chat models, embedding models, and server deployment. Special thanks to my partner [ShenSeanChen](https://github.com/ShenSeanChen), feel free to check out and star [his repo](https://github.com/ShenSeanChen/yt-rag.git)!
